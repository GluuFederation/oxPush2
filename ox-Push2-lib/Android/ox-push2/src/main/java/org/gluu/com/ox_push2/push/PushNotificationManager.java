...
package org.gluu.com.ox_push2.push;
...
import org.gluu.com.ox_push2.listener.PushNotificationRegistrationListener;
...
public class PushNotificationManager {
    ...
    private void storeRegistrationId(final Context context, final String regId) {
        ...
        prefs.edit().putString(PROPERTY_REG_ID, regId).putInt(PROPERTY_APP_VERSION, appVersion).apply();//commit();
    }
